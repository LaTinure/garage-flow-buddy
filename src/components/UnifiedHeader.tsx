      ...
      <div className={`${styles.inner} max-w-[100vw]`}>
        ...
        <div className={styles.leftSection}>
          <button
            ...
            className={`${styles.iconButton} text-white`}
          >
            <ICONS.back />
          </button>
                  ...
                  {item.path ? (
                    <motion.div variants={itemVariants} initial="initial" animate="animate" whileHover={{ scale: 1.05 }}>
                      <Link
                        ...
                        className={`${styles.navItem} text-white ${isActive(item.path) ? styles.active : ''}`}
                        onClick={withRipple}
                      >
                        {IconFor(item.icon)}
                    ...
                    <div className={styles.navDropdown}>
                      <button
                        className={`${styles.navItem} text-white`}
                        aria-haspopup="true"
        ...
        <div className={styles.rightSection}>
          ...
          {showUserMenu ? (
            ...
            <Button variant="ghost" size="sm" className={`${styles.skeletonBtn} text-white`} aria-disabled>
              Chargement...
            </Button>
          )}
        </div>
